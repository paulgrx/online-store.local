        ...
        <div class="box">
            ...
            <div class="basket">
                ...
                <div class="row" id="purchase-data">
                    ...
                    <div class="col-md-2 price"><p>369,99 zł</p></div>
                    <div class="col-md-2 count">
                        <p>1</p>
                        <button class="product-count" type="submit">+</button>
                    </div>
                    <div class="col-md-2 final-price"><p>369,99 zł</p></div>
                ...
                <hr>
                <div class="summarize">
                    <div class="col-md-3 total-count"><p>1 PRODUKT</p></div>
                    <div class="col-md-1 total-in-words"><p>RAZEM</p></div>
                    <div class="col-md-1 total-price"><p>369,99 zł</p></div>
                </div>
            </div>
            <div class="buttons">
                <button class="back-button" type="submit">Z powrotem</button>
                <button class="order-button" type="submit">Zamawiam</button>
            </div>
        </div>
    </body>
</html>
