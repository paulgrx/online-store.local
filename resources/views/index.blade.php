        ...
        <div class="content">
            <div class="header">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <button class="log-in">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="256" height="256" viewBox="0 0 256 256" xml:space="preserve" style="width: 40%; height: 46px;">
            ...
            <div class="main-content">
                <div class="aside">
                    ...
                    <ul>
                        ...
                        <li><a  href="#" class="nav-link active" aria-current="page">Odzież piłkarska</a></li>
