        ...
        <div class="content">
            <div class="header">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 navi-buttons">
                    ...
                    <form action="{{ route('search') }}" method="get" role="search">
                        <div class="col-sm-12 mobile-search-button">
                            <div class="input-group">
                                <input type="search" name="search" class="product-search col-md-11" placeholder="Szukaj" value="{{ isset($searchQuery) ? $searchQuery : '' }}" aria-label="Szukaj">
                                <button type="submit" class="search-button-btn col-md-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
                                    </svg>
                                </button>
